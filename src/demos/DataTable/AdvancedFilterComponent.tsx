...
import { AdvancedFilterProps } from '../../../lib/components/DataTable/types';
import Block from '../../../lib/components/Primitives/Block/Block';
import PrimitiveText from '../../../lib/components/Primitives/PrimitiveText/PrimitiveText';
import PrimitiveInput from '../../../lib/components/Primitives/PrimitiveInput/PrimitiveInput';
...
const AdvancedFilterComponent: React.FC<AdvancedFilterProps> = ({
  ...
  return (
    <Block display="flex" flexDirection="column" gap={FOUNDATION_THEME.unit[16]} style={{ minWidth: '400px' }}>
      <Block display="flex" justifyContent="space-between" alignItems="center">
        <Block display="flex" alignItems="center" gap={FOUNDATION_THEME.unit[8]}>
          <Filter size={16} color={FOUNDATION_THEME.colors.primary[600]} />
          <PrimitiveText 
      ...
      >
        Create custom filters for server-side data processing. These filters are passed to your API for handling.
      </PrimitiveText>
      ...
      {localFilters.length === 0 ? (
        ...
        >
          <Filter size={32} color={FOUNDATION_THEME.colors.gray[400]} />
          <PrimitiveText 
            fontSize={FOUNDATION_THEME.font.size.body.md.fontSize}
        ...
        <Block display="flex" flexDirection="column" gap={FOUNDATION_THEME.unit[12]}>
          {localFilters.map((filter, index) => (
            ...
            >
              {/* Filter Rule Header */}
              <Block display="flex" justifyContent="space-between" alignItems="center" marginBottom={FOUNDATION_THEME.unit[12]}>
                <Block display="flex" alignItems="center" gap={FOUNDATION_THEME.unit[8]}>
                  {index > 0 && (
                    <Block
                      style={{
                ...
                <Button
                  ...
                  style={{ padding: `${FOUNDATION_THEME.unit[4]} ${FOUNDATION_THEME.unit[8]}` }}
                />
              </Block>

              <Block display="grid" style={{ gridTemplateColumns: '1fr 1fr 2fr', gap: FOUNDATION_THEME.unit[12], alignItems: 'end' }}>
          ...
          <Block display="flex" justifyContent="center">
            <Button
              ...
              style={{ 
                borderStyle: 'dashed',
                borderColor: FOUNDATION_THEME.colors.primary[300],
      ...
      {localFilters.length > 0 && (
        ...
        >
          <PrimitiveText 
            ...
            style={{ lineHeight: '1.5' }}
          >
            <strong>{localFilters.length}</strong> filter rule{localFilters.length !== 1 ? 's' : ''} configured. 
            These will be sent to your server for processing.
          </PrimitiveText>
        </Block>
      )}
    </Block>
