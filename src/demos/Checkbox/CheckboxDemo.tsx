    ...
    <Block padding="24px">
      ...
      <Block marginBottom="40px">
        ...
        <Block display="flex" flexDirection="column" gap="16px">
          ...
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              setBasicStates((prev) => ({ ...prev, checked: checked === true }))
            }
          >
            Checked State
          </Checkbox>
          ...
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              setBasicStates((prev) => ({ ...prev, indeterminate: checked }))
            }
          >
            Indeterminate State
          </Checkbox>
      ...
      <Block marginBottom="40px">
        ...
        <Block display="flex" flexDirection="column" gap="16px">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              setSizeExamples((prev) => ({ ...prev, small: checked === true }))
            }
          >
            Small Checkbox
          </Checkbox>
          ...
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              setSizeExamples((prev) => ({ ...prev, medium: checked === true }))
            }
          >
      ...
      <Block marginBottom="40px">
        ...
        <Block display="flex" flexDirection="column" gap="20px">
          ...
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              setSpecialStates((prev) => ({ ...prev, error: checked === true }))
            }
      ...
      <Block marginBottom="40px">
        ...
        <PrimitiveText
          ...
          margin="0 0 16px 0"
        >
          Demonstrates indeterminate state when some but not all children are
          selected
        </PrimitiveText>
      ...
      >
        <PrimitiveText
          ...
          fontWeight={700}
          margin="0 0 24px 0"
          color={FOUNDATION_THEME.colors.red[700]}
        >
          HDFC Themed Checkbox
        </PrimitiveText>
        <ThemeProvider
        ...
        >
          ...
          <Block display="flex" flexDirection="column" gap="16px">
            ...
            <Checkbox
              ...
              onCheckedChange={(val) =>
                setHdfcThemedStates((prev) => ({ ...prev, indeterminate: val }))
              }
            >
              Themed Indeterminate
            </Checkbox>
            <Checkbox disabled>Themed Disabled Unchecked</Checkbox>
            <Checkbox checked disabled>
