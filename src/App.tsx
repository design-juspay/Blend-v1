...
function App() {
  const [showComprehensiveDemo, setShowComprehensiveDemo] = useState(false);
  ...
  return (
    <div className="container">
      <div className="demo-toggle">
        <Button
          buttonType={
            showComprehensiveDemo ? ButtonType.SECONDARY : ButtonType.PRIMARY
          }
          text="Simple Demo"
          onClick={() => setShowComprehensiveDemo(false)}
        />
        <Button
          buttonType={
            showComprehensiveDemo ? ButtonType.PRIMARY : ButtonType.SECONDARY
          }
          text="Comprehensive Demo"
          onClick={() => setShowComprehensiveDemo(true)}
        />
      </div>
