  ...
  TAGS: {
    background: {
      ...
      subtle: {
        ...
        primary: FOUNDATION_THEME.colors.gray[900],
    ...
    borderRadius: {
      squarical: {
        xs: FOUNDATION_THEME.border.radius[10],
        sm: FOUNDATION_THEME.border.radius[10],
        md: FOUNDATION_THEME.border.radius[10],
        lg: FOUNDATION_THEME.border.radius[10],
      },
      rounded: {
